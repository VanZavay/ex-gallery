  ...
  const [exes] = useState([
    {
      ...
      description: 'Первые отношения, было весело и драмматично, часто расходились сходились.Плюсы симпотичная, клевый секс. Минусы паралельно ебалась с другими мужиками.',
      rate: '7/10'
    },
    {
      id: 2,
